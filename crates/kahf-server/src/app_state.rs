...
//! configuration (`JwtConfig`), WebSocket hub (`Hub`), the
//! in-process event bus (`BroadcastEventBus`), and the RBAC
//! enforcer (`RbacEnforcer`). Extracted by handlers via axum's
//! `State` extractor.
